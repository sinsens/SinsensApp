...
namespace SinsensApp.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update SinsensAppDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update SinsensAppEfCoreEntityExtensionMappings to extend the IdentityUser entity

...
{
    public class SinsensAppDbMigrationService : ITransientDependency
    {
        public ILogger<SinsensAppDbMigrationService> Logger { get; set; }

        private readonly IDataSeeder _dataSeeder;
        private readonly IEnumerable<ISinsensAppDbSchemaMigrator> _dbSchemaMigrators;
        private readonly ITenantRepository _tenantRepository;
        private readonly ICurrentTenant _currentTenant;
        private readonly IIdentityUserRepository _identityUserRepository;
        private readonly IIdentityRoleRepository _identityRoleRepository;

        public SinsensAppDbMigrationService(
            IDataSeeder dataSeeder,
            IEnumerable<ISinsensAppDbSchemaMigrator> dbSchemaMigrators,
            ...
            IdentityUserManager identityUserManager)
        {
            ...
            Logger = NullLogger<SinsensAppDbMigrationService>.Instance;
        }
        ...
        private async Task SeedDataAsync(Tenant tenant = null)
        {
            ...
            // 由于多了个角色 WalletUser ，所以这里手动把默认账户绑定一下 Admin 管理员角色
            if (tenant == null)
            {

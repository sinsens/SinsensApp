...
namespace SinsensApp.Migrations
{
    ...
    [Migration("20210720024929_RechangeAccountCurrency2")]
    partial class RechangeAccountCurrency2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SinsensApp.Wallets.Account", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("SinsensApp.Wallets.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("SinsensApp.Wallets.Rate", b =>
                {
                    ...
                    b.ToTable("WalletCurrencyRateDetails");
                });

            modelBuilder.Entity("SinsensApp.Wallets.Tag", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("SinsensApp.Wallets.Transaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("SinsensApp.Wallets.TransactionAttachment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.ToTable("WalletTransactionAttachments");
                });
            ...
            modelBuilder.Entity("SinsensApp.Wallets.Rate", b =>
                {
                    b.HasOne("SinsensApp.Wallets.CurrencyRate", null)
                        .WithMany("Rates")
                        .HasForeignKey("CurrencyRateCode");
                });
            ...
            modelBuilder.Entity("SinsensApp.Wallets.Transaction", b =>
                {
                    b.HasOne("SinsensApp.Wallets.Category", "Category")
                        .WithMany()
            ...
            modelBuilder.Entity("SinsensApp.Wallets.TransactionAttachment", b =>
                {
                    b.HasOne("SinsensApp.Wallets.Transaction", "Transaction")
            ...
            modelBuilder.Entity("TagTransaction", b =>
                {
                    b.HasOne("SinsensApp.Wallets.Tag", null)
                        .WithMany()
                        .HasForeignKey("TagsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SinsensApp.Wallets.Transaction", null)
                        .WithMany()

    ...
    public class SinsensAppApplicationAutoMapperProfile : Profile
    {
        public SinsensAppApplicationAutoMapperProfile()
        {
            ...
            CreateMap<Transaction, TransactionDto>()
                ...
                .ForMember(dto => dto.Date, e => e.MapFrom(entity => entity.Date.HasValue ? entity.Date.Value.ToString("yyyy-MM-dd HH:mm:ss") : ""));
            ...
            CreateMap<Account, AccountsItemDto>()
                .ForMember(x => x.model_state, e => e.MapFrom(entity => entity.IsDeleted ? 2 : 1))
                ...
                .ReverseMap()
                .ForMember(entity => entity.IsDeleted, e => e.MapFrom(dto => dto.model_state == 2))
